...
module.exports = {
    name: "removetotal", // name of the command
      ...
      if(message.author.id === "353353241557204994")
      {
        ...
        if(!amount) {
          message.channel.send("You idiot you did it backwards again")
            ...
            message.channel.send(`Sucessfully removed ${currency}${amount} from your total`)
            } else {
                ...
                message.channel.send(`Successfully removed ${currency}${amount} from ${memberadd.user.username}'s total'`)
              }
          }
      } else {
